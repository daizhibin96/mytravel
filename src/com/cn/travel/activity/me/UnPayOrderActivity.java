...
//		OrderPageService.findHotel("东莞", UnPayOrderActivity.this);
//		OrderPageService.findPoint("东莞", UnPayOrderActivity.this);
		...
		public void onReceive(Context arg0, Intent arg1) {
			...
			if (intentAction.equals("location.hotel")) {
				...
				for(int i = 0;i < hotelList.size(); i++){
					if(hotelList.get(i).getPay().equals("待支付")){
			...
			if (intentAction.equals("location.point")) {
				...
				for(int i = 0;i < pointList.size(); i++){
					if(pointList.get(i).getPay().equals("待支付")){
			...
			OrderAdapter adapter = new OrderAdapter(UnPayOrderActivity.this,
							...
							if (order.getOrdertype() == 1) {
								for(int i = 0;i < hotelList.size(); i++){
									if(hotelList.get(i).getId()==(order.getId())){
										...
										Intent intent1 = new Intent(UnPayOrderActivity.this,
