...
public class CollectionService {
	...
	public void collectService(final Context context,final String username,final HotelBean hotelbean){
							...
							if (resCode == 200) {
								...
								for(int index=0; index< jsonArray.length();index++){
									...
									arrayList.add(collect);
										...
										String hotel = gson.toJson(hotelbean);
										CommentService comm = new CommentService();
										comm.collectService(context, str, hotel, 1);
								//onDestroy();
							} else {
